...
public class RealmTasksAdapter extends RealmBasedRecyclerViewAdapter<FollowItemModel, RealmTasksAdapter.ViewHolder> {

    private ItemClickListener clickListener;

    public RealmTasksAdapter(Context context, RealmResults<FollowItemModel> realmResults, boolean automaticUpdate, boolean animateResults, ItemClickListener clickListener) {
    ...
    class ViewHolder extends RealmViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.task_item_task_name) public TextView taskName;
        private ItemClickListener clickListener;
